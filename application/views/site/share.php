			...
			<div class="share-response">
				...
				<div class="custom-block">
					...
					<div class="addthis_inline_share_toolbox"
						...
						data-media="<?php echo base_url('assets/images/' . $site->site_og_image); ?>"></div>
				</div>
				<div class="custom-block">
					<?php
					if ($site->site_user_can_del == 1) {
						echo '<a class="btn btn-danger" href="' . base_url('hash/' . $quiz->quiz_hash) . '">You can delete this quiz by clicking here</a>';
					}
					?>
				</div>
			</div>
